...
from app.models import Answer, Log, Question, UserPII
...
def explain():
    ...
    if form_data["source_page"] == "lifestyle.html":
        for question_id, (
            ...
            features_dico = update_features_dico(
...
def merci():
    ...
    question_id = (
        Question.query.filter(Question.group_id == "interac").first().question_id
    )
